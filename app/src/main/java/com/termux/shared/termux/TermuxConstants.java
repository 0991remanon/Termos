...
public final class TermuxConstants {
    ...
    public static final String TERMUX_GITHUB_ORGANIZATION_NAME = "termos"; // Default: "termux"
    ...
    /** Termux app name */
    public static final String TERMUX_APP_NAME = "Termos"; // Default: "Termux"
    /** Termux package name */
    public static final String TERMUX_PACKAGE_NAME = "com.termos"; // Default: "com.termux"
    /** Termux GitHub repo name */
    public static final String TERMUX_GITHUB_REPO_NAME = "termos-app"; // Default: "termux-app"
